...
class CurvePainter extends CustomPainter{
  ...
  //path.close();
//
  //paint.color = Resources().fontColor;
...
//
  ...
  //path.close();
//
  //paint.color = Resources().accentColorPink;
  //canvas.drawPath(path, paint);

  path =Path();
  path.lineTo(0, size.height*0.75);
  path.quadraticBezierTo(size.width*0.15, size.height*0.55, size.width*0.20, size.height*0.75);
  path.quadraticBezierTo(size.width*0.25, size.height*0.97, size.width*0.40, size.height*0.75);
  path.quadraticBezierTo(size.width*0.55, size.height*0.50, size.width*0.65, size.height*0.70);
  path.quadraticBezierTo(size.width*0.75, size.height*0.89, size.width, size.height*0.60);
  path.lineTo(size.width, 0);
  path.close();

  paint.color = Resources().primaryColor;
  canvas.drawPath(path, paint);
  }
